...
def test():
    ...
    val_moving_list = sorted(glob.glob(f"{datapath}/*/t1c_bet_normalized_followup.nii.gz"))
    ...
    valid_generator = Data.DataLoader(Validation_Brats(val_fixed_list, val_moving_list, None,
